          ...
          <div>
            <Link href={`/games/${featured.slug}`} style={{ textDecoration: "none", display: "block" }}>
              <div style={{
                ...
                <div className="hero-flex-content" style={{ flex: 1, position: "relative", zIndex: 1, minWidth: 0 }}>
                  ...
                  <h1 style={{ fontSize: "22px", fontWeight: 800, color: "#fff", marginBottom: "4px", letterSpacing: "-0.5px", lineHeight: 1.2 }}>{featured.title}</h1>
                  ...
                  <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.55)", lineHeight: 1.6, marginBottom: "16px" }}>{featured.description}</p>
                ...
                <div className="hero-image" style={{ width: "120px", height: "120px", borderRadius: "12px", flexShrink: 0, overflow: "hidden", position: "relative", zIndex: 1 }}>
                  {featured.cover_url
                    ? <img src={featured.cover_url} alt={featured.title} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    : <div style={{ width: "100%", height: "100%", background: "rgba(167,139,250,0.2)", display: "flex", alignItems: "center", justifyContent: "center" }}><span style={{ fontSize: "40px", fontWeight: 800, color: "rgba(167,139,250,0.4)" }}>{featured.title[0]}</span></div>
                  }
                </div>
              </div>
            </Link>
