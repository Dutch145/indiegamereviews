    ...
    <div>
      ...
      {reviews && reviews.length > 0 ? (
              ...
              {reviews.map((review) => (
                <tr key={review.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-5 py-3 text-right">
                    <Link
                      href={`/admin/reviews/new?edit=${review.id}`}
                      className="text-indigo-600 hover:underline text-xs mr-4"
                    >
                      Edit
                    </Link>
                    <Link
                      href={`/games/${(review.games as any)?.slug}`}
        ...
        <div className="text-center py-16 text-gray-400">
          ...
          <Link href="/admin/reviews/new" className="text-indigo-600 hover:underline text-sm">
